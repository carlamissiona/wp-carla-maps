								...
								<div class="inside">
									<div class="col-md-12">
									  	<div class="col-half" >
									  		...
									  		<div class="input">
												<label for="banner-name">Google Map Api Key<br> 
													<input type="text" name="axi_api" size="60" placeholder="This is your new banner" value="" id="axi-api-key" spellcheck="true" autocomplete="off">
												</label>
											</div>
											<div class="input">										 
												<label for="banner-desc">Default Map Type<br>
													<input type="text" name="axi_map_type" size="60" placeholder="Add a description" value="" id="axi-map-type" spellcheck="true" autocomplete="off">
												</label>	
											</div>
									  	</div>
										<!-- preview images -->
